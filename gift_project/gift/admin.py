...
from .models import (
    ...
    Notification, BrowsingHistory, BulkInquiry, Occasion, Testimonial
)
...
# Address is registered below with AddressAdmin
...
# ============================================================================
# ADMIN FOR NEXT.JS FRONTEND MODELS
# ============================================================================

@admin.register(Occasion)
class OccasionAdmin(admin.ModelAdmin):
    list_display = ['name', 'tagline', 'order', 'is_active', 'product_count']
    list_filter = ['is_active']
...
class TestimonialAdmin(admin.ModelAdmin):
    list_display = ['name', 'city', 'tag', 'rating', 'is_active', 'order', 'created_at']
...
class AddressAdmin(admin.ModelAdmin):
    list_display = ['full_name', 'user', 'city', 'state', 'pincode', 'is_default', 'address_type', 'created_at']
    list_filter = ['is_default', 'address_type', 'state', 'country']
    search_fields = ['full_name', 'phone', 'address_line1', 'city', 'pincode', 'user__username', 'user__email']
