...
export default function Footer() {
  ...
  const shopLinks = [
    ...
    { name: 'Gift Hampers', href: '/collections/hampers' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Thoughtful gifts for every occasion. We help you celebrate life's special moments with premium quality products and exceptional service.
            </p>
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {new Date().getFullYear()} Radhvi. All rights reserved.
            </p>
